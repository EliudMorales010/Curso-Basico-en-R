...
# Las listas pueden agrupar o contener cosas como dataframes, matrices y vectores en una variable
# Para crear una lista utilizamos la funcion list()
# Ejemplo: 
# list(objeto1, objeto2, ...)
# Podemos cambiar nombres con la funcion names()
